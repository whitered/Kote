...
"Asdoc documentation":http://kote.heroku.com/doc/index.html

bq. This is Flash Player 9 version of Kote. If you develop for Flash Player 10 or higher, use faster "Flash Player 10 version":http://github.com/whitered/Kote
...
{
  onSubscribe.addListener(handleSubscribe);
  onRemove.addListener(handleRemove);
}

private function handleSubscribe(mediator:Mediator, notificationType:NotificationType):void
{
  trace("Mediator has subscribed for", notificationType);
}

private function handleRemove(facade:Facade):void
{
